...
export const AutoRespondHandler_ = class AutoRespondHandler extends HandledDiscordEvent {
	...
	constructor() {
        ...
        // this.Responds.set(/(how|where|get).{0,24}?(download|game|release|install)/gmi,"please view <#757935290055786517> to find the octo download link");
        ...
        // this.Responds.set(/(how|where|get|download).{0,24}?mods?/gmi,"you can get mods from the channel <#966808355404382288>. a guide for setting them up can be found [here](<https://astolfo.uk/git/luna/Octo/wiki/Help>)");
	}
